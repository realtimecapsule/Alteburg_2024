...
namespace MFPC.EditorScripts
{
    ...
    {
        private const string DocumentationLink = "https://github.com/Nicel193/MFPCDocs/blob/main/PlayerData.md";
        ...
        {
            if (GUILayout.Button("Open Player Data documentation", GUILayout.Height(30)))
