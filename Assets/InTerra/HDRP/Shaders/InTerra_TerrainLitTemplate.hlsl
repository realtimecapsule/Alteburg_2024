// NOTE! Almost all code in this file and the file InTerra_TerrainLitData is written by Unity and are used because there is no longer the possibility to use the Standard Shader and there would be need to write basically the same Template/LitData for InTerra Shader Functions.
...
#if SHADERPASS != SHADERPASS_DEPTH_ONLY || defined(WRITE_NORMAL_BUFFER) || defined(TESSELLATION_ON)
...
#include "InTerra_TerrainLitData.hlsl"
